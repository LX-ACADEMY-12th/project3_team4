...
import com.team4.mywebapp.MywebappApplication;
...
public class AuthController {
    ...
    private final MywebappApplication mywebappApplication;
	
	@Autowired
	private AuthService authService;

    AuthController(MywebappApplication mywebappApplication) {
        this.mywebappApplication = mywebappApplication;
    }
	...
	public ResponseEntity<String> login(@RequestBody UserDto UserDto, HttpSession session) {
		...
		System.out.println("입력받은 아이디: " + UserDto.getLoginId());
		System.out.println("입력받은 비밀번호: " + UserDto.getLoginPw());
